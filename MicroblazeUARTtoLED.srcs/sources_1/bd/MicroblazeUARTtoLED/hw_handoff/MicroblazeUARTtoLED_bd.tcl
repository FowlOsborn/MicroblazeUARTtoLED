...
################################################################
# This is a generated script based on design: MicroblazeUARTtoLED
#
...
# source MicroblazeUARTtoLED_script.tcl


# The design that will be created by this Tcl script contains the following 
# module references:
# twostage_synchronizer, twostage_synchronizer
...
set design_name MicroblazeUARTtoLED
...
proc write_mig_file_MicroblazeUARTtoLED_mig_7series_0_1 { str_mig_prj_filepath } {
   ...
   puts $mig_prj_file {    <ModuleName>MicroblazeUARTtoLED_mig_7series_0_1</ModuleName>}
...
# End of write_mig_file_MicroblazeUARTtoLED_mig_7series_0_1()
...
proc create_root_design { parentCell } {
  ...
  set sys_diff_clock_233 [ create_bd_intf_port -mode Slave -vlnv xilinx.com:interface:diff_clock_rtl:1.0 sys_diff_clock_233 ]
  set_property -dict [ list \
   CONFIG.FREQ_HZ {233000000} \
   ] $sys_diff_clock_233
  ...
  set_property -dict [ list \
   CONFIG.CLKIN1_JITTER_PS {42.910000000000004} \
   CONFIG.CLKOUT1_JITTER {214.307} \
   CONFIG.CLKOUT1_PHASE_ERROR {272.183} \
   CONFIG.CLKOUT2_JITTER {112.316} \
   CONFIG.CLKOUT2_PHASE_ERROR {89.971} \
   CONFIG.CLKOUT2_USED {false} \
   CONFIG.CLK_IN1_BOARD_INTERFACE {sys_diff_clock_233} \
   CONFIG.MMCM_CLKFBOUT_MULT_F {50.750} \
   CONFIG.MMCM_CLKIN1_PERIOD {4.292} \
  ...
  write_mig_file_MicroblazeUARTtoLED_mig_7series_0_1 $str_mig_file_path
  ...
  # Create instance: twostage_synchronizer_0, and set properties
  set block_name twostage_synchronizer
  set block_cell_name twostage_synchronizer_0
  if { [catch {set twostage_synchronizer_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $twostage_synchronizer_0 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  
  # Create instance: twostage_synchronizer_1, and set properties
  set block_name twostage_synchronizer
  set block_cell_name twostage_synchronizer_1
  if { [catch {set twostage_synchronizer_1 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $twostage_synchronizer_1 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  connect_bd_intf_net -intf_net sys_diff_clock_233_1 [get_bd_intf_ports sys_diff_clock_233] [get_bd_intf_pins clk_wiz_0/CLK_IN1_D]

  # Create port connections
  connect_bd_net -net CPU_RESET_1 [get_bd_ports CPU_RESET] [get_bd_pins vio_0/probe_in0]
  connect_bd_net -net axi_uartlite_0_interrupt [get_bd_pins axi_uartlite_0/interrupt] [get_bd_pins microblaze_0_xlconcat/In0]
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins system_ila_0/clk] [get_bd_pins twostage_synchronizer_0/dst_clk] [get_bd_pins twostage_synchronizer_1/dst_clk] [get_bd_pins vio_0/clk]
  ...
  connect_bd_net -net mig_7series_0_init_calib_complete [get_bd_pins mig_7series_0/init_calib_complete] [get_bd_pins twostage_synchronizer_1/src_signal]
  ...
  connect_bd_net -net mig_7series_0_ui_clk_sync_rst [get_bd_pins mig_7series_0/ui_clk_sync_rst] [get_bd_pins twostage_synchronizer_0/src_signal]
  connect_bd_net -net reset_1 [get_bd_ports reset] [get_bd_pins clk_wiz_0/reset] [get_bd_pins rst_mig_7series_0_200M/ext_reset_in]
  ...
  connect_bd_net -net twostage_synchronizer_0_dst_signal [get_bd_pins system_ila_0/probe0] [get_bd_pins twostage_synchronizer_0/dst_signal]
  connect_bd_net -net twostage_synchronizer_1_dst_signal [get_bd_pins system_ila_0/probe1] [get_bd_pins twostage_synchronizer_1/dst_signal]
