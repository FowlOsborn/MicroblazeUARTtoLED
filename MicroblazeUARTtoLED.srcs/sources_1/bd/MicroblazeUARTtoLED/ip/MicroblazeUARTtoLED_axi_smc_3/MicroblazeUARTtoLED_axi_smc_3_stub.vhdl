...
-- Date        : Fri Apr 25 17:00:21 2025
-- Host        : DESKTOP-8IL51LS running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode synth_stub -rename_top MicroblazeUARTtoLED_axi_smc_3 -prefix
--               MicroblazeUARTtoLED_axi_smc_3_ MicroblazeUARTtoLED_axi_smc_3_stub.vhdl
-- Design      : MicroblazeUARTtoLED_axi_smc_3
...
entity MicroblazeUARTtoLED_axi_smc_3 is
  Port ( 
    aclk : in STD_LOGIC;
...
end MicroblazeUARTtoLED_axi_smc_3;

architecture stub of MicroblazeUARTtoLED_axi_smc_3 is
...
attribute X_CORE_INFO of stub : architecture is "bd_5aac,Vivado 2017.4";
begin
end;
